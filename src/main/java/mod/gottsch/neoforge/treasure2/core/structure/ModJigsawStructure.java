...
import mod.gottsch.neoforge.treasure2.core.structure.templatesystem.ModProcessor;
...
public class ModJigsawStructure extends Structure {
    ...
    public static final MapCodec<ModJigsawStructure> CODEC = RecordCodecBuilder.<ModJigsawStructure>mapCodec((instance) -> {
        ...
        }), IFeatureType.BY_NAME_CODEC.fieldOf("feature_type").forGetter(structure -> {
            return structure.featureType;
    ...
    }).validate(ModJigsawStructure::verifyRange);
    ...
    public ModJigsawStructure(Structure.StructureSettings structureSettings, Holder<StructureTemplatePool> templatePoolHolder, int maxDepth, HeightProvider heightProvider, boolean useExpansionHack, Heightmap.Types types) {
        this(structureSettings, templatePoolHolder, Optional.empty(), maxDepth, heightProvider, useExpansionHack, Optional.of(types), 80, TreasureFeatureTypes.UNKNOWN.get(), 100.0);
    }
    ...
    public ModJigsawStructure(Structure.StructureSettings structureSettings, Holder<StructureTemplatePool> templatePoolHolder, int maxDepth, HeightProvider heightProvider, boolean useExpansionHack) {
        this(structureSettings, templatePoolHolder, Optional.empty(), maxDepth, heightProvider, useExpansionHack, Optional.empty(), 80, TreasureFeatureTypes.UNKNOWN.get(), 100.0);
    }
