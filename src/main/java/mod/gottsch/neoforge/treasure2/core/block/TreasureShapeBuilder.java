...
public class TreasureShapeBuilder {
	...
	public static VoxelShape[] buildGravestone1() {
		...
		return new VoxelShape[] { northSouth, eastWest, northSouth, eastWest };
	}

	public static VoxelShape[] buildGravestone2() {
		VoxelShape northSouth = Shapes.or(
				Block.box(2D, 0D, 5D, 14D, 2D, 11D),
				Block.box(5D, 2D, 7D, 11D, 14D, 9D),
				Block.box(5D, 14D, 7D, 11D, 15D, 9D),
				Block.box(4D, 15D, 7D, 12D, 18D, 9D)
				);
		VoxelShape eastWest = Shapes.or(
				Block.box(5D, 0D, 2D, 11D, 2D, 14D),
				Block.box(7D, 2D, 5D, 9D, 14D, 11D),
				Block.box(7D, 14D, 5D, 9D, 15D, 11D),
				Block.box(7D, 15D, 4D, 9D, 16D, 12D)
				);
		return new VoxelShape[] { northSouth, eastWest, northSouth, eastWest };
	}
	...
	public static VoxelShape[] buildGravestone3() {
		VoxelShape northSouth = Shapes.or(
				Block.box(2D, 0D, 5D, 14D, 2D, 11D),
				Block.box(5D, 2D, 7D, 11D, 9D, 9D),
				Block.box(7D, 9D, 7D, 9D, 15D, 9D),
				Block.box(5D, 15D, 7D, 11D, 16D, 9D)
				);
		VoxelShape eastWest = Shapes.or(
				Block.box(5D, 0D, 2D, 11D, 2D, 14D),
				Block.box(7D, 2D, 5D, 9D, 9D, 11D),
				Block.box(7D, 9D, 7D, 9D, 15D, 9D),
				Block.box(7D, 15D, 5D, 9D, 16D, 11D)
				);
		return new VoxelShape[] { northSouth, eastWest, northSouth, eastWest };
	}
	...
	public static VoxelShape[] buildSkullCrossbones() {
		VoxelShape north = Shapes.or(
				Block.box(5D, 0D, 1D, 11D, 5D, 6D),
				Block.box(1D, 0D, 7D, 15D, 1D, 14D)
				);
		VoxelShape south = Shapes.or(
				Block.box(5D, 0D, 10D, 11D, 5D, 15D),
				Block.box(1D, 0D, 2D, 15D, 1D, 9D)
				);
		VoxelShape east = Shapes.or(
				Block.box(10D, 0D, 5D, 15D, 5D, 11D),
				Block.box(2D, 0D, 1D, 9D, 1D, 15D)
				);
		VoxelShape west = Shapes.or(
				Block.box(1D, 0D, 5D, 6D, 5D, 11D),
				Block.box(7D, 0D, 1D, 15D, 1D, 14D)
				);
	...
	public static VoxelShape[] buildFullBlock() {
		...
		return new VoxelShape[] { block, block, block, block };
	}
	...
	public static VoxelShape[] buildSpiderChest() {
		VoxelShape n = Shapes.or(
				Block.box(2, 7, 6, 14, 16, 16),
				Block.box(4, 7, 0, 12, 15, 6)
				);
		VoxelShape e = Shapes.or(
				Block.box(0, 7, 2, 10, 16, 14),
				Block.box(10, 7, 4, 16, 15, 12)
				);
		VoxelShape s = Shapes.or(
				Block.box(2, 7, 0, 14, 16, 10),
				Block.box(4, 7, 10, 12, 15, 16)
				);
		VoxelShape w = Shapes.or(
				Block.box(6, 7, 2, 16, 16, 14),
				Block.box(0, 7, 4, 6, 15, 12)
				);
		return new VoxelShape[] { n, e, s, w };
	}
	...
	public static VoxelShape[] buildCelestialChest() {
		...
		return new VoxelShape[] { zAxisShape, xAxisShape, zAxisShape, xAxisShape };
	}
}
