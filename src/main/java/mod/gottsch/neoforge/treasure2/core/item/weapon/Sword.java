...
/**
 * This wrapper allows float values for attack damage. In 1.21 the float damage is applied
 * through {@link TreasureWeapons#createAttributes(Tier, float, float)} on the item properties
 * (no reflection, no int truncation).
 *
