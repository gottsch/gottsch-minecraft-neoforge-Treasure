...
public class TreasureChestBlockItem extends BlockItem {
	...
	public static final ICapabilityProvider<ItemStack, Void, IItemHandler> ITEM_HANDLER_PROVIDER =
			(stack, v) -> new ComponentItemHandler(
					stack,
					TreasureComponents.ITEM_INVENTORY.get(),
					27 // the size of your inventory
					// TODO need the size of the chest OR just an all-encompassing large inventory
			);
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
		...
		boolean isLocked = ComponentHelper.lockStates(stack)
