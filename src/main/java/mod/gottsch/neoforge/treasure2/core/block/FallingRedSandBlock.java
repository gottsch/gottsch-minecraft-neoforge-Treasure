 ...
 */
public class FallingRedSandBlock extends AbstractTreasureFallingBlock {
    public static final MapCodec<FallingRedSandBlock> CODEC = simpleCodec(FallingRedSandBlock::new);
    ...
    public void onLand(Level level, BlockPos pos, BlockState state, BlockState replaceableState, FallingBlockEntity entity) {
        level.setBlockAndUpdate(pos, Blocks.RED_SAND.defaultBlockState());
    }
}
