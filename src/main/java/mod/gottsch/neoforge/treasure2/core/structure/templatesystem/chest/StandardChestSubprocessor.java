 ...
 */
public class StandardChestSubprocessor extends ChestSubprocessor {

    public StandardChestSubprocessor() {
    }

    public StandardChestSubprocessor(ChestSubprocessorData data) {
        super(data);
    }
}
