...
import mod.gottsch.neoforge.treasure2.core.item.effects.ILockEffects;
...
public class LockItem extends Item implements ILockEffects {
	 ...
	 * @param keys
	 */
	public LockItem(Properties properties, KeyItem[] keys) {
		this(properties);
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		...
		tooltipComponents.add(Component.translatable(LangUtil.tooltip("key_lock.rarity"),
		...
		LangUtil.appendAdvancedHoverText(tooltipComponents, tt -> {
			...
			tooltipComponents.add(Component.translatable(LangUtil.tooltip("key_lock.accepts_keys")));
			getKeys().forEach(key -> {
