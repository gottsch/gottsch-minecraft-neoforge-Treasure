...
import mod.gottsch.neoforge.treasure2.core.block.entity.CauldronChestBlockEntity;
...
public class CauldronChestModel extends AbstractTreasureChestModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "cauldronchestmodel"), "main");
