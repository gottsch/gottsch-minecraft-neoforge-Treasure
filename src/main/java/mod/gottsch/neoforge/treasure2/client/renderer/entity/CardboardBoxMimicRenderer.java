...
import mod.gottsch.neoforge.treasure2.client.model.entity.CardboardBoxMimicModel;
import mod.gottsch.neoforge.treasure2.client.renderer.entity.layer.CardboardBoxMimicLayer;
import mod.gottsch.neoforge.treasure2.core.entity.monster.CardboardBoxMimic;
...
public class CardboardBoxMimicRenderer extends MobRenderer<CardboardBoxMimic, CardboardBoxMimicModel<CardboardBoxMimic>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/entity/mob/cardboard_box_mimic.png");
