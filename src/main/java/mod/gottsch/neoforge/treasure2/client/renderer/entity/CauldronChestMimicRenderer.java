...
import mod.gottsch.neoforge.treasure2.client.model.entity.CauldronChestMimicModel;
import mod.gottsch.neoforge.treasure2.client.renderer.entity.layer.CauldronChestMimicLayer;
import mod.gottsch.neoforge.treasure2.core.entity.monster.CauldronChestMimic;
...
public class CauldronChestMimicRenderer extends MobRenderer<CauldronChestMimic, CauldronChestMimicModel<CauldronChestMimic>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/entity/mob/cauldron_chest_mimic.png");
