...
import mod.gottsch.neoforge.treasure2.core.block.entity.SafeBlockEntity;
...
public class SafeModel extends AbstractTreasureChestModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "safe"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha, AbstractTreasureChestBlockEntity blockEntity) {
		safe.render(poseStack, vertexConsumer, packedLight, packedOverlay);
