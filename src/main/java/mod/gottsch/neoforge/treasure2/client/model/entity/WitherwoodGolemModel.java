...
public class WitherwoodGolemModel<T extends Entity> extends EntityModel<T> implements IHumanlikeModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "witherwood_golem"), "main");
    ...
    @Override
    public ModelPart getBody() { return torso; }
