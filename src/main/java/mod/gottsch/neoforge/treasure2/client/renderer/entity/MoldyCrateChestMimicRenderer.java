...
import mod.gottsch.neoforge.treasure2.client.model.entity.MoldyCrateChestMimicModel;
import mod.gottsch.neoforge.treasure2.client.renderer.entity.layer.MoldyCrateChestMimicLayer;
import mod.gottsch.neoforge.treasure2.core.entity.monster.MoldyCrateChestMimic;
...
public class MoldyCrateChestMimicRenderer extends MobRenderer<MoldyCrateChestMimic, MoldyCrateChestMimicModel<MoldyCrateChestMimic>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/entity/mob/moldy_crate_chest_mimic.png");
