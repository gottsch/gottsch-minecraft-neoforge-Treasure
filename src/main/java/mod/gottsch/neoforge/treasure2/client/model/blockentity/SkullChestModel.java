 ...
 */
package mod.gottsch.neoforge.treasure2.client.model.blockentity;
...
public class SkullChestModel extends AbstractTreasureChestModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "skull_chest"), "main");
	public static final ModelLayerLocation GOLD_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "gold_skull_chest"), "main");
	public static final ModelLayerLocation CRYSTAL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "crystal_skull_chest"), "main");
