...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.CompressorChestModel;
...
public class CompressorChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation COMPRESSOR_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/compressor_chest");
