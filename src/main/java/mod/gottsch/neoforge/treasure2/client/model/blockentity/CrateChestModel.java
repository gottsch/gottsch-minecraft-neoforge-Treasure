...
import mod.gottsch.neoforge.treasure2.core.block.entity.CrateChestBlockEntity;
...
public class CrateChestModel extends AbstractTreasureChestModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "crate_chest"), "main");
	public static final ModelLayerLocation MOLDY_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "moldy_crate_chest"), "main");
