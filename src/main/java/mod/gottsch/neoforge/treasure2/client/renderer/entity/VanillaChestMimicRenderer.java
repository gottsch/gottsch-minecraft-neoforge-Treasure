...
import mod.gottsch.neoforge.treasure2.client.model.entity.VanillaChestMimicModel;
import mod.gottsch.neoforge.treasure2.client.renderer.entity.layer.VanillaChestMimicLayer;
import mod.gottsch.neoforge.treasure2.core.entity.monster.VanillaChestMimic;
...
public class VanillaChestMimicRenderer extends MobRenderer<VanillaChestMimic, VanillaChestMimicModel<VanillaChestMimic>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/entity/mob/vanilla_chest_mimic.png");
