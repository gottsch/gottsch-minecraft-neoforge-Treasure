 ...
 */
package mod.gottsch.neoforge.treasure2.client.model.blockentity;// Made with Blockbench 4.12.6
...
public class CelestialChestModel extends AbstractTreasureChestModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "celestial_chest"), "main");
