...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.CauldronChestModel;
...
public class CauldronChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation CAULDRON_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/cauldron_chest");
	...
	public void updateLockRotation(PoseStack matrixStack, LockState lockState) {
		...
		matrixStack.mulPose(Axis.ZP.rotationDegrees(lockState.getSlot().getRotation()));
	}
