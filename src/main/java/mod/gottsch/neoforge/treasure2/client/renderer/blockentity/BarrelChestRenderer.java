...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.BarrelChestModel;
...
public class BarrelChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation BARREL_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/barrel_chest");
