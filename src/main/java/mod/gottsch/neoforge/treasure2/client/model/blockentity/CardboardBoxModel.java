...
import mod.gottsch.neoforge.treasure2.core.block.entity.CardboardBoxBlockEntity;
...
public class CardboardBoxModel extends AbstractTreasureChestModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "cardboard_box"), "main");
