...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.SpiderChestModel;
...
public class SpiderChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation SPIDER_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/spider_chest");
