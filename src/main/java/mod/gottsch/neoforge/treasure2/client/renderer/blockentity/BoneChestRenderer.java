...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.BoneChestModel;
...
public class BoneChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation BONE_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/bone_chest");
