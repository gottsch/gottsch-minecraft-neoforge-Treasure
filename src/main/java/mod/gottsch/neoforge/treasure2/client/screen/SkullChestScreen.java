...
public class SkullChestScreen extends AbstractChestScreen<SkullChestContainerMenu> {
	...
	private static final ResourceLocation VANILLA_BG_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/gui/screen/vanilla_skull_chest.png");
	private static final ResourceLocation BG_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/gui/screen/skull_chest.png");
	private static final ResourceLocation GOLD_BG_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/gui/screen/gold_skull_chest.png");
	private static final ResourceLocation CRYSTAL_BG_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/gui/screen/crystal_skull_chest.png");
