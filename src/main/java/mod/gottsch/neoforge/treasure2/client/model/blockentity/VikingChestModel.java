...
public class VikingChestModel extends AbstractTreasureChestModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "viking_chest"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		mainBox.render(poseStack, vertexConsumer, packedLight, packedOverlay);
