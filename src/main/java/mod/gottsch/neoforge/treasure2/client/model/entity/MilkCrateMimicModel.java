...
public class MilkCrateMimicModel<T extends Entity> extends MimicModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "milk_crate_mimic"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tongueMain = main.addOrReplaceChild("tongue", CubeListBuilder.create().texOffs(43, 0).addBox(-3.0F, 0.9F, -12.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 7.0F, -0.1745F, 0.0F, 0.0F));
    ...
    @Override
    public ModelPart getLid() { return lid; }
}
