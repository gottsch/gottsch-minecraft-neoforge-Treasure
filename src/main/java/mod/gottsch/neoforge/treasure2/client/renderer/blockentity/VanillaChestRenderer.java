...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.VanillaChestModel;
...
public class VanillaChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation VANILLA_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/vanilla_chest");
