...
public class BoundSoulModel<T extends Entity> extends EntityModel<T> implements IHumanlikeModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "bound_soul_model"), "main");
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.leftArm.xRot = -0.8726646F;
        this.rightArm.zRot = 0F;
        this.rightArm.xRot = -0.9599311F;
    ...
    public static void bobModelPart(ModelPart part, float age, float direction) {
        part.xRot += direction * (Mth.cos(age * 0.15F) * 0.15F + 0.05F);
    }
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        body_legs.render(poseStack, buffer, packedLight, packedOverlay, color);
