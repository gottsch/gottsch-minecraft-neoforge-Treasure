...
import mod.gottsch.neoforge.treasure2.client.model.entity.MilkCrateMimicModel;
import mod.gottsch.neoforge.treasure2.client.renderer.entity.layer.MilkCrateMimicLayer;
import mod.gottsch.neoforge.treasure2.core.entity.monster.MilkCrateMimic;
...
public class MilkCrateMimicRenderer extends MobRenderer<MilkCrateMimic, MilkCrateMimicModel<MilkCrateMimic>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "textures/entity/mob/milk_crate_mimic.png");
