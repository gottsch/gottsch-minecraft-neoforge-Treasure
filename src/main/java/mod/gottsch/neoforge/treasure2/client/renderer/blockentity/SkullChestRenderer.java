...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.SkullChestModel;
...
public class SkullChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation SKULL_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/skull_chest");
	public static final ResourceLocation GOLD_SKULL_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/gold_skull_chest");
	public static final ResourceLocation CRYSTAL_SKULL_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/crystal_skull_chest");

	public static SkullChestRenderer createGoldSkull(BlockEntityRendererProvider.Context context) {
		return new SkullChestRenderer(context,
