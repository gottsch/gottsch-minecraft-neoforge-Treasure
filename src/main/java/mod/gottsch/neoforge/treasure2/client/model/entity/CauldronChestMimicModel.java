 ...
 */
package mod.gottsch.neoforge.treasure2.client.model.entity;
...
public class CauldronChestMimicModel<T extends Entity> extends MimicModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "cauldron_chest_mimic"), "main");
    ...
    public void activeAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        rightLid.zRot = -2.26893F;
        leftLid.zRot = -rightLid.zRot;
        spike1.xRot = 1.13446F;
        ...
        eye2.xRot = eye1.xRot;
        eye3.xRot = eye1.xRot;
        tongue.xRot = -0.174533F;

        frontSwing1.xRot = Mth.cos(limbSwing * 0.349066f) * 1.4F * limbSwingAmount;
        backSwing1.xRot = Mth.cos(limbSwing * 0.349066f + (float) Math.PI) * 1.4F * limbSwingAmount;
    ...
    public void openAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float timeSlice) {
        ...
        rightLid.zRot = timeSlice * -2.26893F;
        leftLid.zRot = -rightLid.zRot;
        spike1.xRot = timeSlice * 1.13446F;
        spike2.xRot = timeSlice * 0.959931F;
        spike3.xRot = timeSlice * 0.7854F;
