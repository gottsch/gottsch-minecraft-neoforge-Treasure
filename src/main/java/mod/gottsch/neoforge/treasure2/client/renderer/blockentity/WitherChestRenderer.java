...
import mod.gottsch.neoforge.treasure2.client.model.blockentity.WitherChestModel;
...
public class WitherChestRenderer extends AbstractChestBlockEntityRenderer {
	public static final ResourceLocation WITHER_CHEST_RENDERER_ATLAS_TEXTURE = ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "entity/chest/wither_chest");
