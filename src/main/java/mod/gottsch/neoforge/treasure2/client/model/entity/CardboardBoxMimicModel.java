...
public class CardboardBoxMimicModel<T extends Entity> extends MimicModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Treasure.MODID, "cardboard_box_mimic"), "main");
