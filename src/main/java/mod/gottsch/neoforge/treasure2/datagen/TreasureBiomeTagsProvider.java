...
import mod.gottsch.neoforge.treasure2.datagen.tags.BiomesOPlenty;
import mod.gottsch.neoforge.treasure2.datagen.tags.BiomesWeveGone;
...
public class TreasureBiomeTagsProvider extends BiomeTagsProvider {
    ...
    public TreasureBiomeTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookup, ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        // ocean based
        tag(TreasureTags.Biomes.AQUATIC).addTags(BiomeTags.IS_OCEAN);
        ...
        // BWG
        tag(TreasureTags.Biomes.ALL_OVERWORLD).addOptionalTag(ResourceLocation.fromNamespaceAndPath(BiomesWeveGone.BWG, "overworld"));
